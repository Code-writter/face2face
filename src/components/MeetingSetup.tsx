...
export default function MeetingSetup({onSetupComplete} : {onSetupComplete : () => void}){
    ...
    // state to check camera is disabled or not
    const [isCameraDisabled, setIsCameraDisabled] = useState(true)

    console.log( "check", isCameraDisabled)
    // state to check microphone is disabled or not
    const [isMicroPhoneDisabled, setIsMicoPhoneDisabled] = useState(false)
          ...
          <div className="w-full max-w-[1200px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="md:col-span-1 p-6 flex flex-col">
                ...
                {/* VIDEO PREVIEW */}
                <div className=" flex-1 min-h-[400px] rounded-xl overflow-hidden bg-muted/50 border relative">
                    ...
                    <div className="spacey-6 mt-8">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) => setIsMicoPhoneDisabled(!checked)}
                        />
                      </div>
